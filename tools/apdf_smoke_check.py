...
class SmokeRunner:
    ...
    def check_edit_ui_controls(self) -> str:
        ...
        required_ids = [
            ...
            "textOverlayBold",
            "textOverlayItalic",
            "textOverlayUnderline",
            "textOverlayOpacity",
            "textOverlayClearAfterApply",
            "addImageOverlayOp",
            "imageOverlayFile",
            "imageOverlayName",
            "imageOverlayPage",
    ...
    def check_edit_combined_queue(self) -> str:
        ...
        operations = [
            ...
            {"type": "overlay_text", "page": 1, "x": 72, "y": 72, "text": "APDF Combo wrapped text", "font_size": 14, "color": "#d62828", "bold": True, "italic": False, "underline": True, "opacity": 0.9, "max_width": 180},
