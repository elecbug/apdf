...
- Core HTML pages
- Edit page UI control IDs, including drag-and-drop target, Preview Zoom, coordinate inspector, Append PDF, Page Numbers, Add Text, Add Image, and Undo controls
